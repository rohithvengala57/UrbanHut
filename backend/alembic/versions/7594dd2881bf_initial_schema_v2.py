...
def upgrade() -> None:
    ...
    sa.Column('looking_in', sa.ARRAY(sa.String()), nullable=True),
    ...
    sa.Column('split_details', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('house_rules', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('nearby_universities', sa.ARRAY(sa.String()), nullable=True),
