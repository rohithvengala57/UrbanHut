...
async def record_event(
    ...
    *,
    ...
    event = TelemetryEvent(
        ...
        occurred_at=ts,
        event_date=ts.date(),
        utm_source=channel_touch.get("source") or (properties or {}).get("source"),
        utm_medium=channel_touch.get("medium") or (properties or {}).get("medium"),
        utm_campaign=channel_touch.get("campaign") or (properties or {}).get("campaign"),
